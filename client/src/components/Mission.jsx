...
import ShoePhotoCopy from '../assets/ShoePhotoCopy.jpg'
...
export default function Mission() {
  ...
  return (
    ...
    <div className='max-w-[1400px] xl:h-[1200px] lg:h-[700px] h-[780px] xs:h-[390px] md:h-[700px] w-full xl:justify-center xl:place-content-center xl:px-auto xl:mx-auto py-12 relative group '>
      ...
      <div className='bg-sky-400 absolute w-2/3 bottom-14 xl:pt-12 opacity-70 hover:opacity-100 rounded-lg items-center p-2 mb-2 pb-2 text-center text-xl absolute text-white xs:left-0 xs:h-1/3 xs:w-5/6 xs:mx-8 xs:text-clip xs:overflow-auto xs:text-base md:left-10 md:h-1/3 md:text-xl'>
      ...
      <div className="hidden group-hover:block absolute top-[50%] -translate-x-0 translate-y-[50%] right-5 py-auto  text-2xl rounded-full p-2 bg-black/20 text-white cursor-pointer">
      ...
      <div className="flex top-4 justify-center py-2">
        {slides.map((slide, slideIndex) => (
          ...
          className='text-2xl cursor-pointer'>
            <i className="fa-solid fa-circle-dot text-white opacity-70 hover:opacity-100 active:opacity-100 mx-2 "></i>
          </div>
        ))}
      </div>
    </div>
