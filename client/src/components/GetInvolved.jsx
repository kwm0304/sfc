...
export default function GetInvolved() {
  ...
  return (
    <section id='involved'>
      ...
      <h2 className='text-center text-sky-600 xs:text-2xl xs:mt-8 md:my-8 md:text-3xl uppercase font-semibold'>Donating Shoes</h2>
      <div className="lg:grid xl:grid xl:grid-cols-3 md:grid md:grid-cols-2 md:gap-8 xl:mx-auto lg:grid-cols-3 xs:grid-cols-1 xs:gap-4 xs:mx-6 justify-items-center mb-12">
        <div className='google-map xs:grid xs:grid-cols-1 xs:justify-items-center xs:left-0 xs:p-0 xs:ml-0 md:ml-32 my-auto'>
        <iframe className='xs:left-8 xs:ml-0 xs:pl-0 xs:scale-75 md:scale-100' src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3251.2113251833807!2d-80.68036822359117!3d35.42479474401709!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8854045545fe0e1d%3A0x4f21e1941dda756e!2s732%20Kannapolis%20Pkwy%2C%20Concord%2C%20NC%2028027!5e0!3m2!1sen!2sus!4v1682811538285!5m2!1sen!2sus" width="500" height="375" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
        ...
        <div className='grid gap-4  xl:place-items-center md:grid md:place-items-center md:text-base md:ml-28 lg:grid xl:place-content-center text-center sm:text-base md:gap-4 md:ml-12  lg:text-xl xl:text-2xl xl:gap-16  xl:align-items-middle xl:place-content-center xs:mt-4 lg:mt-0 xl:mt-0'>
          <div className='rounded-lg xl:h-auto  bg-sky-600 text-white xs:text-lg xs:p-4 sm:text-lg md:text-sm md:p-8 lg:text-xl xl:h-24 xl:text-2xl font-semibold p-8 w-full'>
