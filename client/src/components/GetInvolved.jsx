    ...
    <section id='involved'>
      ...
      <div className="lg:grid xl:grid xl:grid-cols-3 md:grid md:grid-cols-2 md:gap-8  lg:grid-cols-3 xs:grid-cols-1 xs:gap-4 xs:mx-6 xl:ml:8 mb-12">
        ...
        <div className='rounded-lg bg-sky-600  text-white xl:h-44 xl:h-auto  text-2xl xs:text-lg md:text-base py-auto lg:text-xl xl:text-2xl xl:h-24  p-8 w-full text-center'>
          ...
          <p className='text-center xl:invisible'>Contact us to coordinate a more convenient drop-off or pickup location</p> 
        </div>
        ...
        <div className='rounded-lg bg-sky-600 border-8 border-solid border-sky-600 xl:h-auto text-white text-2xl xs:text-lg md:text-base  lg:text-xl xl:text-2xl xl:h-24  p-8 w-full text-center'>
          ...
          {/* <h5 className='text-center uppercase font-bold '>Unable to get to the dropbox?</h5> */}
           <p className='text-center '>Contact us to coordinate a more convenient drop-off or pickup location</p> 
        </div>
        ...
        <div className='flex flex-row w-full xl:gap-4 xs:px-4 justify-center xl:place-content-center xl:gap-8 xl:h-full xl:mr-12 xs:gap-4 xs:items-center md:gap-0 lg:grid-cols-1  md:mt-4 xs:pt-12'>
          ...
          <div className="text-2xl text-white font-bold  md:text-xl xs:text-sm">{formatDistance(new Date(), new Date(2024, 2, 21))} until</div>
          <p className='text-lg text-white uppercase xs:text-base'> March shipment</p>
          </div>
          ...
          <div className="text-2xl text-white font-bold xs:text-lg md:text-xl xs:text-sm">{formatDistance(new Date(), new Date(2023, 7, 31))} until</div>
          <p className='text-lg text-white uppercase xs:text-base'> August shipment</p>
          </div>
        </div>
